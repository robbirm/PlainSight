  ...
  const items = [
    ...
    { id: 'obj9', top: '26.6%', left: '98.7%', hint: 'Carved into a tree' },
	...
	{ id: 'obj16', top: '24.05%', left: '56%', hint: 'Caught in the fence' },
	{ id: 'obj17', top: '5.55%', left: '54%', hint: 'Stick through the tree' },
	{ id: 'obj18', top: '6.55%', left: '21.4%', hint: 'A screaming tree!' },
	{ id: 'obj19', top: '6.05%', left: '9%', hint: 'Mr Ruffles!' },
	{ id: 'obj20', top: '90.2%', left: '37.7%', hint: 'The Bunny Team Mascot' },
	{ id: 'obj21', top: '25.05%', left: '70%', hint: 'Coconuts growing in a tree' },
	{ id: 'obj22', top: '6.45%', left: '88.8%', hint: 'It has 3 eyes!' },
	{ id: 'obj23', top: '20.9%', left: '12%', hint: '4 leaf flower' },
...
const qm15 = document.querySelector('[data-id="qm15"]');
...
function openCave1() {
  caveInterior1.style.display = 'block';
	...
	const qm14 = document.querySelector('[data-id="qm14"]');
	const qm15 = document.querySelector('[data-id="qm15"]');	
	const gnome3reveal = document.querySelector('#gnomeReveal3');
  ...
  if (qm15) qm15.style.display = 'block';
  if (qm15) qm15.style.zIndex = '10';
  if (gnome3reveal) gnome3reveal.style.display = 'block';
  if (gnome3reveal) gnome3reveal.style.zIndex = '10';
...
function closeCave1() {
  ...
  if (qm14) qm14.style.display = 'none';
        const qm15 = document.querySelector('[data-id="qm15"]');
  if (qm15) qm15.style.display = 'none';
	const gnome3reveal = document.querySelector('#gnomeReveal3');
	  if (gnome3reveal) gnome3reveal.style.display = 'none';
